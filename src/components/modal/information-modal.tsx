    ...
    <ModalWrapper onClick={() => dispatch(setModal(null))}>
      <ModalWindow>
        ...
        <MainContent>
          <h3>Data</h3>
          <span>
            The data consists of COVID-19 cases and location clusters in Singapore.
            {' '}
            The data in this website is open sourced, and is freely available on this
            {' '}
            <ArticleLink
          ...
          <span>
            ...
            {' '}
            <ArticleLink
              href='https://weileizeng.github.io/Open-Source-COVID-19/world'
              target='_blank'
              rel='noopener noreferrer'
              title='World data'
            >
          ...
          <h3>Methods</h3>
          <span>
            The data is visualised in a map format, using Mapbox.
            {' '}
            Apart from maps, the data can be visualised in other formats such as tables and bar charts.
          </span>
        </MainContent>
      </ModalWindow>
    </ModalWrapper>
